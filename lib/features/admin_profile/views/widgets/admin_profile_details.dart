...
import '../../../../core/common/widgets/circular_image_container.dart';
import '../../../../core/constants/strings/app_colors.dart';

class AdminPictureWidget extends StatelessWidget {
  const AdminPictureWidget({super.key, required this.image});
  final String image;
  //...CONSTANT VALUES
